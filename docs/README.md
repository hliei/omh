...
Start with the [project README](../README.md) for installation and Session examples, or the [harness overview](harness.md) for the runtime model and an execution trace.
